...
(function () {
  ...
  function buildOfferCard(v) {
    ...
    return [
      ...
      '          <a href="' + v['Shop URL'] + '" class="acs-button acs-button-fw">' + (v['Button Label'] || 'Shop Now') + '</a>',
      '        </div>',
      '      </div>',
      '      <hr>',
      '      <div class="acs-mb-5 acs-text-4 acs-lh-6">',
      '        <p class="acs-my-2 acs-text-center"><sup>[1]</sup> ' + v['Disclaimer'] + '</p>',
      '      </div>',
      '    </div>',
      '  </div>',
      '</div>'
